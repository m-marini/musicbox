 ...
 *
 * $Id: ToneShiftPaletteEntry.java,v 1.1 2008/11/20 21:07:25 marco Exp $
 *
 * 17/nov/08
 *
 * Copyright notice
 ...
 * @version $Id: ToneShiftPaletteEntry.java,v 1.1 2008/11/20 21:07:25 marco Exp
 *          $
 * 
 */
public class ToneShiftPaletteEntry extends AbstractPaletteEntry {

	/**
         * 
         */
	public ToneShiftPaletteEntry() {
	}
	...
	public TransformNode createSampleTransformer(SoundProcessor processor) {
		return processor.createToneShiftNode();
	}
