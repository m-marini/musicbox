 ...
 *
 * $Id: VolumePaletteEntry.java,v 1.1 2008/11/20 21:07:25 marco Exp $
 *
 * 17/nov/08
 *
 * Copyright notice
 ...
 * @version $Id: VolumePaletteEntry.java,v 1.1 2008/11/20 21:07:25 marco Exp $
 * 
 */
public class VolumePaletteEntry extends AbstractPaletteEntry {

	/**
         * 
         */
	public VolumePaletteEntry() {
	}
	...
	public TransformNode createSampleTransformer(SoundProcessor processor) {
		return processor.createVolumeNode();
	}
