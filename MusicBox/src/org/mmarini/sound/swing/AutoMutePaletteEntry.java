 ...
 *
 * $Id: AutoMutePaletteEntry.java,v 1.1 2008/11/20 21:07:26 marco Exp $
 *
 * 17/nov/08
 *
 * Copyright notice
 ...
 * @version $Id: AutoMutePaletteEntry.java,v 1.1 2008/11/20 21:07:26 marco Exp $
 * 
 */
public class AutoMutePaletteEntry extends AbstractPaletteEntry {

	/**
         * 
         */
	public AutoMutePaletteEntry() {
	}
	...
	public TransformNode createSampleTransformer(SoundProcessor processor) {
		return processor.createAutoMuteNode();
	}
